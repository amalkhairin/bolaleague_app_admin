...
import 'package:bolalucu_admin/config/quarter_helper.dart';
import 'package:bolalucu_admin/config/user_helper.dart';
import 'package:bolalucu_admin/constant/colors.dart';
import 'package:bolalucu_admin/page/acivate_phase/quarter_final/quarter_leg_detail.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(24),
                      child: Icon(Icons.emoji_events, size: 200, color: Colors.orangeAccent[700],),
                    ),
                    SizedBox(
                      height: 64,
                              ...
                              actions: [
                                ...
                                TextButton(
                                  onPressed: () async {
                                    ...
                                    var data = await UserHelper.updatePhase(idPhase: "3", isOpen: "1");
                                    var data2 = await QuarterHelper.drawQuarter();
                                    checkPhase();
